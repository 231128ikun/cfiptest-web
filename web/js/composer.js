...
const PLACEHOLDERS = {
    ...
    '{dc}': r => r.dataCenter ?? '',
    '{dataCenter}': r => r.dataCenter ?? '',
    '{locCode}': r => r.locCode ?? '',
    '{region}': r => r.regionZh || r.region || '',
    '{asn}': r => r.asn || '',
    '{asnOrg}': r => r.asnOrg ?? '',
    '{ipType}': r => r.ipType ?? '',
...
export const PRESETS = [
    { name: 'IP:Port#国家', template: '{ip}:{port}#{country}' },
    { name: 'IP:Port#国旗国家', template: '{ip}:{port}#{emoji}{country}' },
